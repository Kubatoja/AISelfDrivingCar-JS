  ...
  constructor(x, y, width, height, controlType, maxSpeed = 1.5) {
    ...
    Promise.all([
      new Promise((resolve) => {
        ...
        this.imgPlayer.src = "porshePLAYER.png"; // Set the correct path
      }),
      new Promise((resolve) => {
        this.imgDUMMY.onload = resolve;
        this.imgDUMMY.src = "porsheDUMMY.png"; // Set the correct path
      }),
      new Promise((resolve) => {
        this.imgDamaged.onload = resolve;
        this.imgDamaged.src = "porsheDamaged.png"; // Set the correct path
      }),
    ]).then(() => {
      this.imgLoaded = true;
